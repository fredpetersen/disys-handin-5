...
type AuctionHouseClient interface {
	Bid(ctx context.Context, in *BidType, opts ...grpc.CallOption) (*Ack, error)
...
func (c *auctionHouseClient) Bid(ctx context.Context, in *BidType, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
type AuctionHouseServer interface {
	Bid(context.Context, *BidType) (*Ack, error)
...
func (UnimplementedAuctionHouseServer) Bid(context.Context, *BidType) (*Ack, error) {
...
func _AuctionHouse_Bid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionHouseServer).Bid(ctx, req.(*BidType))
	}
